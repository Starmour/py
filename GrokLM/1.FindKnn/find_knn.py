...
for (
    ...
    votes[cls] = (
        votes.get(cls, 0) + 1
    )  # запись в словарь голосов количества ключей равных значениям переменной cls (если таких нет - 0, и запись в словарь, если есть, то + 1 )
